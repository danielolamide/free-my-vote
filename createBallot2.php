<?php
	...
	if ((!isset($_SESSION['userName']))||($_SESSION['uType']==="user")) {
		...
		if(isset($_POST['submit'])){
			...
			$votes =0;
			$insert2 = $con->query("INSERT INTO pm_candidates(name,votes) VALUES('$candi1','$votes')");
			$insert3 = $con->query("INSERT INTO pm_candidates(name,votes) VALUES('$candi2','$votes')");
			$insert4 = $con->query("INSERT INTO pm_candidates(name,votes) VALUES('$candi3','$votes')");
			if($insert2&&$insert3&&$insert4){
				echo "<script>alert('Successfully added ballot');</script>";
			}
...
<body>
	...
	<div id="ballot-div">
		<form id="create-ballot-form" method="post" action="createBallot2.php">
